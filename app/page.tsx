...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-stone-100">
      {/* Header */}
      <header className="bg-white shadow-md sticky top-0 z-10 border-b-2 border-green-200">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 justify-end">
              ...
              <span className="hidden lg:inline-block text-xs text-gray-600 italic whitespace-nowrap ml-2">
                Mehr bilan, Ibrohim Iskandarov
              </span>
            </div>
          </div>
        </div>
